...
#define YAWTIMEOUT 5000  //5S
    ...
    switch (search_step) {
        case 0: g_motor_driver.set_pwm(200, -200); break;  // 左转
        case 1: g_motor_driver.set_pwm(-200, 200); break;  // 右转
        case 2: g_motor_driver.set_pwm(150, 150); break;   // 前进
        case 3: g_motor_driver.set_pwm(-150, -150); break; // 后退
    }
    // 检查是否找到线路
    if (0 == lost_spto) {
